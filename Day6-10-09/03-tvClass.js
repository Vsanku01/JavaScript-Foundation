class TV {
  constructor(_brand, _channel = 1, _price, _inches, _onOffStatus, _volume = 50) {
    this.brand = _brand;
...
class LED extends TV{
    constructor(_screenThickness, _energyUsage, _lifeSpan, _refreshRate, _viewingAngle, _backLight, _displayDetails){
